    ...
    return (
      <AnimatedPage>
        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-[#FAF8F3] dark:bg-[#101826]">
          ...
          <Link
            to="/our-team"
            className="text-assent hover:underline"
          >
    ...
    <AnimatedPage>
      ...
      <div className="min-h-screen bg-[#FAF8F3] pb-16 sm:pb-24 dark:bg-[#101826] pt-8 sm:pt-12">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <Link
            to="/our-team"
            className="font-docket flex items-center gap-2 text-xs uppercase tracking-widest text-secondary-assent hover:text-[#101826] dark:text-assent dark:hover:text-white mb-8 sm:mb-12"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-1 lg:sticky lg:top-6 max-w-xs mx-auto w-full sm:max-w-sm lg:max-w-none">
              <div className="overflow-hidden rounded-sm border border-assent/20 bg-white p-4 dark:bg-[#16223a] shadow-xs">
                <img
                  src={member.image}
                ...
                />
                <div className="mt-4 pt-4 border-t border-assent/10 text-center">
                  <h3 className="font-display text-lg text-[#101826] dark:text-white">
                    {member.name}
                  </h3>
                  <p className="text-xs text-secondary-assent dark:text-assent uppercase tracking-wider mt-1">
                    {member.position}
                  </p>

                  <div className="flex items-center justify-center gap-4 mt-4 text-secondary-assent dark:text-assent">
                    <a
            ...
            <div className="lg:col-span-2">
              <header className="border-b border-assent/20 pb-4 sm:pb-6 mb-6 sm:mb-8 text-center lg:text-left">
                <h1 className="font-display text-2xl sm:text-3xl lg:text-4xl text-[#101826] dark:text-white mb-2 wrap-break-word">
                  {member.name}
                </h1>
                <p className="text-secondary-assent dark:text-assent font-sans text-sm sm:text-base">
                  {member.title}
                </p>
              </header>

              {/* Renders the full multi-line detailed essay segments dynamically */}
              <div className="text-sm sm:text-base leading-relaxed text-primary-text dark:text-white/75 space-y-4 sm:space-y-6">
              ...
              <div className="mt-8 sm:mt-12 p-5 sm:p-8 border border-assent/20 bg-white dark:bg-[#16223a]/30 rounded-sm text-center lg:text-left">
                <h4 className="font-display text-base sm:text-lg text-[#101826] dark:text-white mb-2">
                  Book Counsel with {member.name}
                </h4>
                <p className="text-sm text-primary-text/80 dark:text-white/60 mb-4">
                  Set up a private session directly to align litigation
                  parameters or advisory operations with our partners.
                </p>
                <Link
                  to="/appointment"
                  className="w-full sm:w-auto rounded-sm bg-assent px-6 py-2.5 text-xs font-bold text-[#101826] uppercase tracking-wider hover:bg-[#dbbb8c] cursor-pointer"
                >
                  Book Appointment
                </Link>
              </div>

...
const ContactUs = () => {
  ...
  return (
    <m.div initial="hidden" animate="visible" className="pb-20">
      {/* Hero Banner */}
      <m.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-12 max-w-6xl mx-auto px-6">
        ...
        >
          <div className="text-center">
            <h1 className="font-bold text-gray-800 dark:text-light-text">
              Call us
            </h1>
            <a

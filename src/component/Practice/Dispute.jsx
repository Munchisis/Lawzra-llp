import { MoveLeft, Gavel, Handshake, Scale, Globe, Users, Briefcase, FileText, CheckCircle2 } from "lucide-react";
...
const Dispute = () => {
  const expertise = [
    {
      title: "Negotiation",
      desc: "Settling disputes efficiently through structured dialogue and strategic compromise.",
      icon: <Handshake size={18} className="text-green-500" />,
    },
    {
      title: "Mediation",
      desc: "Facilitating sessions to reach mutually acceptable, non-adversarial resolutions.",
      icon: <Users size={18} className="text-green-500" />,
    },
    {
      title: "Arbitration",
      desc: "Representing clients in private, binding, or non-binding international proceedings.",
      icon: <Gavel size={18} className="text-green-500" />,
    },
    {
      title: "Litigation",
      desc: "Vigorous advocacy in State and Federal courts for complex legal battles.",
      icon: <Scale size={18} className="text-green-500" />,
    },
    {
      title: "ADR Mechanisms",
      desc: "Advising on the full spectrum of alternative dispute resolution options.",
      icon: <CheckCircle2 size={18} className="text-green-500" />,
    },
    {
      title: "International Disputes",
      desc: "Handling cross-border arbitration and multi-jurisdictional legal conflicts.",
      icon: <Globe size={18} className="text-green-500" />,
    },
    {
      title: "Commercial Disputes",
      desc: "Resolving contractual, business transaction, and corporate governance issues.",
      icon: <Briefcase size={18} className="text-green-500" />,
    },
    {
      title: "Construction Claims",
      desc: "Navigating delays, defects, and contract breaches in infrastructure projects.",
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundImage: `url(${assets.dispute || assets.aboutUs4})` }}
      >
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="max-w-2xl mx-auto text-slate-200 text-lg md:text-xl font-light">
            Comprehensive legal services to resolve conflicts through strategic negotiation, arbitration, and litigation.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center px-4 md:px-10 lg:px-20 -mt-10 mb-20 relative z-20">
        <div className="w-full max-w-6xl bg-white dark:bg-slate-900 p-8 md:p-16 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl transition-colors duration-300">
          ...
          <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 mb-16 leading-relaxed text-center max-w-4xl mx-auto">
            We prioritize efficiency and discretion, helping our clients navigate complex legal challenges while protecting their reputations and commercial interests.
          </p>
          ...
          <div className="mt-20 text-center border-t border-slate-100 dark:border-slate-800 pt-12">
            <h4 className="text-slate-900 dark:text-white font-bold text-xl mb-6">Facing a legal conflict that requires expert intervention?</h4>
            <Link
              to="/appointment"

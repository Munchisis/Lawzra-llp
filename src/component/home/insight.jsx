...
const Insight = () => {
  ...
  useEffect(() => {
    sanityClient
      ...
      .catch((err) => console.error("Failed to load homepage insights:", err))
  ...
  // avoids an empty/broken-looking block on first load or before any
  // insights have been published
